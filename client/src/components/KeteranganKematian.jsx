...
const KeteranganKematian = () => {
  ...
  const [lokasiPemakaman, setLokasiPemakaman] = useState('')
  // surat pengantar
...
const handleSaveToDb = async() => {
  try {
    const response = await axiosJWT.post(
      `${import.meta.env.VITE_BASEURL}/surat/kematian`,
      {
      data_diri: `${nomorSuratIndex},${nama},${tempatLahir}${ttl},${jk},${agama},${kewarganegaraan},${pekerjaan},${alamat},${tanggalMeninggal},${lokasiPemakaman}`,
...
//ENDTOKEN HANDLER
  ...
  const createPdf = () => {
    ...
    const pdfContent = (
        ...
        <Page style={{padding: '50px'}}>
          ...
          <Text style={StyleSheet.create({textAlign: 'center', textDecoration: 'underline', fontSize: 15, marginTop: 10})}>SURAT KETERANGAN KEMATIAN</Text>
          ...
          <View style={StyleSheet.create({display: 'flex', flexDirection: 'row', marginLeft: 80})}>
            <Text style={StyleSheet.create({fontSize: 12, width: 100, textAlign: 'left'})}>Alamat Terakhir</Text>
            <Text style={StyleSheet.create({marginLeft: 10, fontSize: 12, width: 200, flexWrap: 'wrap'})}>: {toUpperCaseFirstStr(alamat)}</Text>
          </View>
    
          <Text style={StyleSheet.create({fontSize: 12, textIndent: 50, marginTop: 30})}>Berdasarkan surat pengantar dari {toUpperCaseFirstStr(dari)} {toUpperCaseFirstStr(lingkungan)} Nomor: {nomorSurat} tanggal {tanggalSaatIni}, menerangkan dengan sebenarnya bahwa:</Text>
          ...
          <View style={StyleSheet.create({display: 'flex', flexDirection: 'row', gap: 5, marginTop: 5})}>
                ...
                <Text style={StyleSheet.create({fontSize: 12})}>Memang benar yang namanya tersebut diatas semasa hidupnya  adalah penduduk yang bertempat tinggal di wilayah kami {toUpperCaseFirstStr(lingkungan)} Kelurahan Mataram Timur Kecamatan Mataram.</Text>
          </View>
    
          <View style={StyleSheet.create({display: 'flex', flexDirection: 'row', gap: 5, marginTop: 5})}>
                <Text style={StyleSheet.create({fontSize: 12})}>2. </Text>
                <Text style={StyleSheet.create({fontSize: 12})}>Selanjutnya kami terangkan bahwa yang bersangkutan memang benar telah meninggal dunia pada {toUpperCaseFirstStr(tanggalMeninggal)}, dan telah di Makamkan di {toUpperCaseFirstStr(lokasiPemakaman)}.</Text>
          </View>
  ...
  return (
    <form action="" style={{width: '100%'}} onSubmit={handlePrint}>
      <h1 className='mb-5 mt-5' style={{fontSize: '20px', color: 'white', fontWeight: 'bold', borderRadius: '10px', textAlign: 'center'}}><span><i style={{position: 'absolute', marginTop: '3px', marginLeft: '-30px'}}><CIcon icon={cilNotes}/></i></span> SURAT KETERANGAN KEMATIAN</h1>
      ...
      <div className="data-diri" style={{backgroundColor: 'white', padding: '100px', width: '100%', borderRadius: '10px'}}>
        ...
        <div className="field">
            ...
            <p className="help has-text-black">Masukkan nama</p>
        </div>
        ...
        <div className="field">
            ...
            <p className="help has-text-black">Masukkan pekerjaan</p>
        </div>
        <label className="label has-text-black">Alamat Terakhir</label>
        <div className="field">
            <div className="control">
            ...
            <p className="help has-text-black">Masukkan alamat terakhir</p>
        </div>
        <label className="label has-text-black">Meninggal Pada</label>
        <div className="field">
            <div className="control">
                <input className="input is-fullwidth has-background-white has-text-black" type="text" placeholder="" onChange={(e) => {setTanggalMeninggal(e.target.value)}} required/>
            </div>
            <p className="help has-text-black">Contoh: 18 Juni 2024</p>
        </div>
        <label className="label has-text-black">Lokasi Pemakaman</label>
        <div className="field">
            <div className="control">
                <input className="input is-fullwidth has-background-white has-text-black" type="text" placeholder="" onChange={(e) => {setLokasiPemakaman(e.target.value)}} required/>
            </div>
            <p className="help has-text-black">Masukkan lokasi pemakaman</p>
        </div>
      </div>
      ...
      <div className="data-diri" style={{backgroundColor: 'white', padding: '100px', width: '100%', borderRadius: '10px', marginTop: '30PX'}}>
        ...
        <div className="field">
            ...
            <p className="help has-text-black">Pilih dari mana surat pengantar</p>
